...
import { createPostService, disLikeService, geMyPostService, getAllPostService, likeService, submitCommentService } from "./post.service.js"
...
export const submitCommentControler = async (req,res) => {
    try {
        ...
        const data = await submitCommentService(req.params.id, req.params.postid, req.body.commentText)
        res.status(200).json({
            statusCode: 200,
            message: 'success',
            total: data.lenghth,
